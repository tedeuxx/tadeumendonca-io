...
| [0005](./0005-og-coverage-every-public-url.md) | Every public URL is SEO- and OG-complete | accepted · route enumeration struck 2026-07-29 (#234 — cite `routes.mjs`, do not re-list) · **extended 2026-07-30** by [0041](./0041-per-article-og-cards.md) (on the article route, OG-complete now means the card is *distinct*, not merely present) |
...
| [0041](./0041-per-article-og-cards.md) | Per-article OG cards — one 1200×630 PNG per article per locale, generated at build time and committed; keyed by the article KEY (never the per-locale slug), `ogImage` derived in `buildEditions` after the fact-parity loop (never authored — it is a `FACT_KEYS` member); regenerated wholesale, overflowing titles refused, and a missing **or** orphaned card is a red build | accepted · extends [0005](./0005-og-coverage-every-public-url.md) · same shape as [0040](./0040-build-time-mermaid-diagrams.md) · constrained by [0037](./0037-localized-article-slugs.md) + [0036](./0036-per-locale-urls-prerender-hreflang.md) |

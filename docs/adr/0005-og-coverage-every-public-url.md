...
because it drifted, #234: the CV route was renamed `/cv` → `/me` and the `/cv` REDIRECT dropped, in two separate 2026-07-24 amendments to ADR-0010; and every public URL is now

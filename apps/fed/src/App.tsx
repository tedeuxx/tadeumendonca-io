// App root — a static landing + CV + portfolio + ramp-up + markdown-blog SPA. No backend. The landing
// (/) is the content shop window and owns the #artigos / #portfolio / #contato anchors; /cv hosts the
// CV, /portfolio the full catalog, /ramp-up the open AI-Engineer plan, /blog/:slug the canonical article. React Query wraps the (static)

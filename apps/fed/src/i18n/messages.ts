...
const strings = {
  ...
  architecture: {
    ...
    metaDescription: {
      ...
      pt: 'Como este site é construído: a SPA estática em S3 + CloudFront, o conteúdo em markdown no repo prerenderizado no build, o dev-loop de agent-led verification, e os ADRs que registram cada decisão — com links para replicar.',

...
const strings = {
  ...
  architecture: {
    ...
    metaDescription: {
      ...
      //
      //   pt — len 195 · `agent-led verification` at 15–37 · `R$ 34,31/mês de conta` complete at 154
      ...
      pt: 'Um dev-loop de agent-led verification: ferramentas de desenvolvimento agêntico na mão e mesmo assim de fora do hype. O que saiu daí: R$ 34,31/mês de conta e as decisões que sustentam peso em ADR.',

...
export const catalog: CatalogProject[] = [
  {
    ...
    description: {
      ...
      en:
        ...
        'through an agent-driven SDLC: plan-first, blocking CI gates, deploy on merge. The repo is the source of truth.',
    },
    ...
    proof: {
      pt:
        'como um SDLC agent-driven se fecha na prática, do plan-first ao deploy — e por onde começar a ' +
        'ler o repo: os ADRs registram cada decisão e o trade-off que ela custou.',
      en:
        'how an agent-driven SDLC actually closes, from plan-first to deploy — and where to start reading ' +

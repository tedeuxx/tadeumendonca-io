...
// to mirror. What it still is: the trigger for `brand-guardian`, now the only lens on these words. The FACTS below (name, owner, language, repoUrl) are authored once and carry no

...
## USD 6.57 a month — and USD 6.42 of that is the .io domain
...
- **AWS** — **USD 6.57/month**, and it is the only charge this site created: 5.92 of amortized annual registration and 0.50 of fixed hosted zone.
...
- **A portfolio at `/portfolio`**, which a project enters by clearing the written bar — the proof-of-engineering gate in [docs/catalog-ready.md](https://github.com/tedeuxx/tadeumendonca-io/blob/main/docs/catalog-ready.md).

...
flowchart TB
  ...
  SK["69 skills · skills/<br/>what the model reaches for"]
  CM["autonomy-on<br/>new-issue<br/>2 commands · commands/<br/>what you type"]
...
| `harness-reviewer` | the machinery itself: hooks, permissions, briefs, skills and commands, the plugin | **me** — and that is the interesting case |

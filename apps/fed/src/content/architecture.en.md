...
flowchart LR
  ...
  subgraph LANE["kind · what -skills exports"]
    direction TB
    LH["hooks · 14<br/>hooks.json<br/>13 scripts — one is registered twice"]

...
So the honest shape is **one measured bill, a set of conditional zeros, and two subscriptions that would bill with or without this site** — and not one of them moves with readers. Going private, growing the estate, registering a name: all decisions. More visitors: nothing.

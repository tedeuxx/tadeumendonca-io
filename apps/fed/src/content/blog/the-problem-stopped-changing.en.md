...
Both times what I changed was the **object** of the work rather than the company — and I only saw it the second time.

How I got there was different. At Globo it came from inside the assignment: there was plenty to learn, and it was doing observability that showed me what I wanted was application work. At AWS it came from outside — the role has not worn out, the new problem ran out, and the work taking me past it is outside what I am staffed on.

A pattern you can name is one you can recognise before it turns into resentment. Both times I recognised it in time. It is not a method; it is what happens when you pay attention to what actually interests you. But it repeated cleanly enough that I would tell a peer to go looking for it in their own history.

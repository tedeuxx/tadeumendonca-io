...
flowchart LR
  ...
  subgraph LANE["tipo · o que o -skills exporta"]
    direction TB
    LH["hooks · 14<br/>hooks.json<br/>13 scripts — um está registrado duas vezes"]

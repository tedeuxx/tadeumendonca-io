...
flowchart TB
  ...
  SK["69 skills · skills/<br/>o que o modelo aciona"]
  CM["autonomy-on<br/>new-issue<br/>2 comandos · commands/<br/>o que você digita"]
...
| `harness-reviewer` | a maquinaria em si: hooks, permissões, instruções das personas, skills e comandos, o plugin | **eu** — e esse é o caso interessante |

...
Ele não está em nada do inventário acima — nem no desenho, nem no manifesto — e é a sessão principal: o contexto que lê uma Issue, decide qual persona acionar, pesa o que volta e roda o merge. Vale ser exato sobre o que falta, porque é nessa frase que quem adota vai agir, e o plugin **não** é omisso a respeito dele. O README de lá desenha o orquestrador como um nó e avisa que ele é *um relé, e relé distorce*; o `autonomy-on` é um comando publicado cujo assunto inteiro é a política de acionamento do orquestrador. Ou seja: o **ator** não é componente do plugin, a **política** dele em parte é, e o que você põe é o contexto que roda aquilo — e é essa a metade que vale conhecer antes de adotar qualquer coisa.

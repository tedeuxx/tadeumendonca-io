...
É também por isso que a conta logo abaixo é tão baixa: **quase tudo nessa trilha cobra com ou sem visitante, e o que uma visita acrescenta em cima disso arredonda pra nada.** Nenhuma das duas metades é "de graça" — é custo fixo mais um variável pequeno o bastante pra sumir, que é uma afirmação mais estreita que "custo quase zero" e mais durável.

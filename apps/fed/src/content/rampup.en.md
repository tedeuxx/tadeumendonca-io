...
This is my ramp-up in the open. I already work as an AI Engineer — applied GenAI and the AI-native development loop — built on {{years}} years across SDLC and distributed systems as a cloud and distributed-applications architect. This page is the plan for the depth I'm still building, the reasoning behind it, and the exact sources I'm using. I'm sharing it because most "become an AI Engineer" content is either ML-PhD gatekeeping or hype threads, and neither helped me.
...
**How this started:** in early 2026 I picked up Kiro — an agentic IDE — and the AI-native loop clicked. It moved into my personal life next (Claude, Cowork), then into personal projects built with Claude Code. The tool clicking and feeling part of what is happening are not the same thing, and they did not arrive together: for a good stretch after this I still felt outside the hype, with the tools already in my hands. The architecture page carries that half. This site and this ramp-up are part of that same move: a transition I'm living in the open, not a claim I'm making.
...
- **[Andrej Karpathy](https://www.youtube.com/@AndrejKarpathy)** — foundational LLM deep-dives; the clearest "what's actually under the hood" long-form there is. Nothing new since February 2025 — this is an archive, and still the best of its kind.
...
- **[@AnthropicAI](https://x.com/AnthropicAI)** · **[@ClaudeDevs](https://x.com/ClaudeDevs)** · **[@bcherny](https://x.com/bcherny)** (Boris Cherny, Claude Code) — closest to the source on agentic development tooling.
...
- **[@JensenHuang](https://x.com/JensenHuang)** (Jensen Huang, NVIDIA) — he runs the company that makes the hardware this whole field runs on.
...
- PT-BR: **[@glaucia_lemos86](https://x.com/glaucia_lemos86)** (Glaucia Lemos) — a Brazilian dev voice going deep on this.
